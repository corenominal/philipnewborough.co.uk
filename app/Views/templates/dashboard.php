                ...
                <div class="offcanvas-body p-0 d-flex flex-column">
                    <nav class="flex-grow-1 py-3" aria-label="Sidebar navigation">
                        ...
                        <ul class="nav flex-column mb-3">
                            ...
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center gap-2 text-white-50 px-3 py-2" href="/admin/taglines">
                            ...
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center gap-2 text-white-50 px-3 py-2" href="/admin/cache">
